...
const Sidebar = () => {
  ...
  return (
    <div className="hidden md:block p-5 max-h-screen hover:overflow-y-scroll overflow-hidden overscroll-contain fixed top-[64px] z-50 bg-white text-left w-[280px]">
      <ul>
        <Link to="/">
